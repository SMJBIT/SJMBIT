The following is a list of assets used in the sjmbit source and their proper attribution.
...
### Info
* Designer: md2k7
* Site: https://sjmbittalk.org/index.php?topic=15276.0
...
### Info
* Designer: Jonas Schnelli (based on the original sjmbit logo from Bitboy)
* License: MIT
